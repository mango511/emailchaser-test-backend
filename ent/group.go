...
type GroupEdges struct {
	...
	Group []*User `json:"group,omitempty"`
...
func (e GroupEdges) GroupOrErr() ([]*User, error) {
	if e.loadedTypes[0] {
		return e.Group, nil
	}
...
// QueryGroup queries the "group" edge of the Group entity.
func (gr *Group) QueryGroup() *UserQuery {
	return NewGroupClient(gr.config).QueryGroup(gr)
}
